...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val gridviewPeliculas : GridView = findViewById(R.id.gridPeliculas) as GridView
        val gridviewSeries : GridView = findViewById(R.id.gridSeries) as GridView
    ...
    class PeliculaAdapter : BaseAdapter {
        ...
        override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
            ...
            vista.setOnClickListener() {
                var intent = Intent(context, DetallePeliculaActivity::class.java)
